...
<div className="p-4 w-full">
        <div className="h-full bg-white p-8 rounded">
          ...
          <a href="https://www.google.com" className="inline-flex items-center">
    ...
    <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
      <div className="p-4 md:w-1/3 md:mb-0 mb-6 flex flex-col text-center items-center">
        ...
        <div className="flex-grow">
          ...
          <a href="https://www.google.com" className="mt-3 text-indigo-500 inline-flex items-center">Learn More
